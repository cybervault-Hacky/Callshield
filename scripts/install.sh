#!/usr/bin/env bash
# CALLSHIELD installer (Termux / Linux) — Phase 5.
#
# - Verifies Python 3.8+
...
echo "Phase 5 supports explicitly confirmed ACTIVE protection. Fresh installs remain disabled and DRY_RUN; uncertainty always fails open to ALLOW."
